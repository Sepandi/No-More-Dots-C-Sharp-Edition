    ...
    public class Game1 : Game
    {
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            if (menuActive == false)
            {
                ...
                float bitDown = bitPos.Y + 24;
                float bitRight = bitPos.X + 24;
                float playerHalfX = playerPos.X + 16;
                float playerHalfY = playerPos.Y + 24;
                if (playerHalfX > bitPos.X && playerHalfX < bitRight && playerHalfY > bitPos.Y && playerHalfY < bitDown)
                {
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            else
            {
                ...
                _spriteBatch.DrawString(smallerFont, "By Sepandi", new Vector2(630, 580), new Color(106, 190, 48));
            }
            _spriteBatch.End();
